...
// CVS $RCSfile: MATIS_CheckerBoolean.h,v $
// CVS $Date: 2006/01/05 08:06:09 $
// CVS $Revision: 1.1 $

#ifndef MATIS_CHECKERBOOLEAN_H
#define MATIS_CHECKERBOOLEAN_H 1
...
namespace MATIS {
     ...
     */
    class CheckerBoolean : public Checker {
    public:
