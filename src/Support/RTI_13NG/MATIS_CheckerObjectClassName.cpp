...
bool CheckerObjectClassName::checkValues(boost::any actionValue, std::string modelValue){
    ...
    try {
        ...
        LOGWRN("Value provided by the Action is not a RTI ObjectClassName.\n");
        return false;
    ...
    actionStr = Types::replaceCIString(actionStr, "objectroot.", "");
    modelValue = Types::replaceCIString(modelValue, "objectroot.", "");
