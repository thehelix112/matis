...
// CVS $RCSfile: RTI_attributeOwnershipAcquisitionIfAvailable2.cpp,v $
...
void FAKE_RTI_NAME::attributeOwnershipAcquisitionIfAvailable(RTI::ObjectHandle theObject,
...
*/
	...
	LOGMSG(3, "Requesting attributeOwnershipAcqusitionIfAvailable for " << theObject << "\n");
