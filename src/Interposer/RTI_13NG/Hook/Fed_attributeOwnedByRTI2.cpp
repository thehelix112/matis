...
// CVS $RCSfile: Fed_attributeOwnedByRTI2.cpp,v $
...
void MATIS_FederateAmbassador::attributeOwnedByRTI(RTI::ObjectHandle theObject,
...
*/
    ...
    theaction.actionContext = Action::ATTRIBUTE_OWNED_BY_RTI;
    theaction.channelId = channelId;
    TypeConversion_RTI_13NG::addMeta_ObjectInstanceHandle(&theaction, theObject);
    
    LOGMSG(2, "Requesting attributeOwnedByRTI for " << theObject << "\n");
