...
// CVS $RCSfile: Fed_initiateFederateSave1.cpp,v $
...
// 4.12
void MATIS_FederateAmbassador::initiateFederateSave(const char *label)
...
*/
    ...
    theaction.actionContext = Action::INITIATE_FEDERATE_SAVE;
    theaction.channelId = channelId;
    TypeConversion_RTI_13NG::addMeta_PointLabel(&theaction, label);

    LOGMSG(3, "Requesting initiateFederateSave for " << channel->federateHandle << "\n");
