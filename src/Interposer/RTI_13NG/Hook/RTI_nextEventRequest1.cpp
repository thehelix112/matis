...
// CVS $RCSfile: RTI_nextEventRequest1.cpp,v $
...
void FAKE_RTI_NAME::nextEventRequest(const RTI::FedTime & theTime)
...
*/
   ...
   //create action
	...
	theaction.actionContext = Action::NEXT_EVENT_REQUEST;
	TypeConversion_RTI_13NG::addMeta_Timestamp(&theaction, theTime);

	LOGMSG(3, "Requesting nextEventRequest \n");
