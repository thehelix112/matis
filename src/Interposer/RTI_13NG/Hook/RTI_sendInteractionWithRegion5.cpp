...
// CVS $RCSfile: RTI_sendInteractionWithRegion5.cpp,v $
...
RTI::EventRetractionHandle FAKE_RTI_NAME::sendInteractionWithRegion(RTI::InteractionClassHandle theInteraction,
...
*/
	...
	theaction.actionContext = Action::SEND_INTERACTION_WITH_REGION5;
