...
// CVS $RCSfile: Fed_attributesInScope2.cpp,v $
...
// 6.13
void MATIS_FederateAmbassador::attributesInScope(RTI::ObjectHandle theObject,
...
*/
    ...
    theaction.actionContext = Action::ATTRIBUTES_IN_SCOPE;
    theaction.channelId = channelId;
    TypeConversion_RTI_13NG::addMeta_ObjectInstanceHandle(&theaction, theObject);

    LOGMSG(2, "Requesting attributesInScope for " << theObject << "\n");
