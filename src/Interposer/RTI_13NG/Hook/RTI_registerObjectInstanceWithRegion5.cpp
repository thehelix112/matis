...
// CVS $RCSfile: RTI_registerObjectInstanceWithRegion5.cpp,v $
...
*/
	...
	theaction.actionContext = Action::REGISTER_OBJECT_INSTANCE_WITH_REGION5;
	...
	LOGMSG(3, "Requesting registerObjectInstanceWithRegion4 for " << theObject << "\n");
