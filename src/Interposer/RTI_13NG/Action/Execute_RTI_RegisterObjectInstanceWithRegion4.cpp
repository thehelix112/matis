...
// CVS $RCSfile: Execute_RTI_RegisterObjectInstanceWithRegion4.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_RegisterObjectInstanceWithRegion4(Channel_RTI_13NG* channel, Action* action){
