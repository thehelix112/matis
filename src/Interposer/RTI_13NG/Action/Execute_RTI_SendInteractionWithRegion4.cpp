...
// CVS $RCSfile: Execute_RTI_SendInteractionWithRegion4.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_SendInteractionWithRegion4(Channel_RTI_13NG* channel, Action* action){

    //make the real call
    MATIS_RTIAmbassador::sendInteractionWithRegion(
