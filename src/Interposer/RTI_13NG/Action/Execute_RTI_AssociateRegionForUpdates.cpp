...
// CVS $RCSfile: Execute_RTI_AssociateRegionForUpdates.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_AssociateRegionForUpdates(Channel_RTI_13NG* channel, Action* action){
    
    //make the real call
    MATIS_RTIAmbassador::associateRegionForUpdates(
