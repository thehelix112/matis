...
// CVS $RCSfile: Execute_RTI_DeleteObjectInstance3.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_DeleteObjectInstance3(Channel_RTI_13NG* channel, Action* action){

   returnValue.valErh = MATIS_RTIAmbassador::deleteObjectInstance(
