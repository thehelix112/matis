...
// CVS $RCSfile: Execute_RTI_SubscribeObjectClassAttributesWithRegion.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_SubscribeObjectClassAttributesWithRegion(Channel_RTI_13NG* channel, Action* action){
 
	    
    //make the real call
    MATIS_RTIAmbassador::subscribeObjectClassAttributesWithRegion(
