...
// CVS $RCSfile: Execute_Fed_DiscoverObjectInstance.cpp,v $
...
void* Action_RTI_13NG::execute_Fed_DiscoverObjectInstance(Channel_RTI_13NG* channel, Action* action){


        
    //make the real call
    channel->internalFedAmb->discoverObjectInstance(
