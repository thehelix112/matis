...
// CVS $RCSfile: Execute_RTI_SendInteraction3.cpp,v $
...
void* Action_RTI_13NG::execute_RTI_SendInteraction3(Channel_RTI_13NG* channel, Action* action){

		
    //make the real call
    MATIS_RTIAmbassador::sendInteraction(
